...
Mounting: this means rendering elements to the DOM.  
Updating: A component gets updated everytime the state of the component changes, causing a re-render
Unmounting: This is when something on the DOM is removed.  
...
Stateful logic is any code that usually uses state.  Also known as non-visual behavior.

5. Describe how to test a React component with React Testing Library.

To test a component you have to render the component(kinda like wrapping).  This tests if the component renders and then from there you should be able to test different things such as elements, inputs, buttons, etc. 
